  ...
  <div class="flex lg:flex-row flex-col w-full h-full">
    <div class="lg:w-1/2 lg:flex justify-center items-center p-5 dark:text-white text-gray-600">
      <div class="flex flex-col gap-2">
        ...
        <p class="text-[1.3rem] p-3 font-semibold">Ejemplos de esquemas</p>
    ...
    <div
      class="flex flex-col gap-2 lg:w-1/2 justify-center items-center p-5 dark:text-white text-gray-600 w-full h-full text-sm"
    >
      ...
      >
        <p class="text-lg font-semibold">¿Cómo funciona?</p>
